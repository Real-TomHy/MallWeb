...
<body>
	...
	<div class="container">
		...
		<div>
			<hr />
			<form class="orderForm" id="orderForm" action="${pageContext.request.contextPath }/confirmOrder" style="margin-top: 5px; margin-left: 150px;" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="inputPassword3" name="name"
							   placeholder="请输收货人" value="${cartuser.name }">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="confirmpwd" name="telephone"
							   placeholder="请输入联系方式"  value="${cartuser.telephone }">
					</div>
				</div>
