			...
			<div class="col-md-8"
				...
				<form id="myform" class="form-horizontal" action="${pageContext.request.contextPath}/register" method="post" style="margin-top: 5px;">
					...
					<div class="form-group opt">
						...
						<div class="col-sm-6">
							<label class="radio-inline"> <input type="radio" name="sex" id="inlineRadio1" value="male">
								男
							</label> <label class="radio-inline"> <input type="radio" name="sex" id="inlineRadio2" value="female">
								女
							</label>
						</div>
					</div>
